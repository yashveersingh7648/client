    ...
    <section className="know-more-section">
      <div className="know-more-container">
        <div className="know-more-content">
          <h2 className="know-more-title">{title}
              <span className="decorative-line"></span>
            
          </h2>
          <p className="know-more-description">{description}</p>
          <div className="know-more-buttons">
            <a href={contactLink} className="know-more-button">
