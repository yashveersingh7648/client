  ...
  return (
    <>
      ...
      <div className="contact-page">
        <div className="breadcrumb-banner " style={{ backgroundImage: `url(/Images/contactUs.jpg)` }}>
          <div className="breadcrumb-content4">
            <h1>Contact Us</h1>
          ...
          <div className="contact-container">
            ...
            <div className="contact-info1">
              ...
              <div className="info-item">
                ...
                <p><strong>Address:</strong> RUSTAMPUR SAKET KHA SHREE DHAM; COLONY Aligarh</p>
              </div>
              <div className="info-item">
                <Mail className="icon" />
                <p><strong>Mail Us:</strong> <a href="mailto:info@finetmtplus.com">info@finetmtplus.com</a></p>
              </div>
              <div className="info-item">
                <PhoneCall className="icon" />
                <p><strong>Phone:</strong> +91 8447490707</p>
              </div>
            </div>
            ...
            <div className="contact-form">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  <label>Message *</label>
                  <textarea name="message" rows="4" value={formData.message} onChange={handleChange} placeholder="Your Message"></textarea>
                  {errors.message && <p className="error">{errors.message}</p>}
                </div>
                <button type="submit" disabled={isSubmitting} className={`submit-btn ${isSubmitting ? "disabled" : ""}`}>
                  {isSubmitting ? "Sending..." : <><Send className="send-icon" /> Send Message</>}
                </button>
              </form>
            </div>
          </div>
