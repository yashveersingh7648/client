...
// Presence
const Presence = () => {
  const statesLeft = ["Jammu and Kashmir", "Uttarakhand", "Rajasthan", "Punjab", "Chandigarh", "Delhi"];
  const statesRight = ["Himachal Pradesh", "Uttar Pradesh", "Jharkhand", "Bihar", "Haryana"];

  return (
    <section className="section-white">
      <SectionTitle
        title="Our Presence"
        subtitle="TMT Plus products are available across these states, with plans to expand nationwide"
      />
      <div className="presence-layout">
        <ul>
          {statesLeft.map((state, i) => (
            <li key={i}><span className="dot"></span>{state}</li>
          ))}
        </ul>
